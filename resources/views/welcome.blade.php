        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth {{-- if there is any authenticated login, then it will show what is below --}}

                        {{-- url /home diambil dari RouteServiceProvider, kemudian ngarah ke routes/web.php --}}
                    ...
                    @else {{-- if there is no authenticated login, then it will show what is below --}}
